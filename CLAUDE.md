...
Never add Claude or any AI as a co-author or collaborator in commits, PRs, or anywhere on GitHub. Commits must only show the user as the author — no `Co-Authored-By` lines.
